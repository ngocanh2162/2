...
SPECIAL_WORD = ['từ', 'đến', 'ở']

dict_f = os.path.join("data","dictionary")
l = []
l.append([['thành_phố'], ['tỉnh']])
l.append([['quận'], ['thị_trấn'], ['huyện'], ['phường'], ['khối'], ['xóm'], ['xã'], ['thôn'], ['làng']])
l.append([['rạp_phim'], ['công_viên'], ['sở_thú'], ['rạp_xiếc'], ['quán'], ['bảo_tàng'], ['trung_tâm'], ['sân'],['rạp'],['tháp']])
l.append([['công_ty'], ['nhà_máy'], ['ga'], ['bến_xe'], ['khu_đô_thị'], ['khách_sạn'], ['nhà_nghỉ'], ['chung_cư'], ['lăng'], ['tòa'], ['tòa_nhà'], ['chợ'], ['cầu'], ['ngân_hàng'], ['bệnh_viện'], ['nghĩa_trang'], ['tập_thể']])
